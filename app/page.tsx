    ...
    <main className="px-10 flex flex-col gap-10">
      ...
      <section id="career">
        ...
        <div className="pb-5">
          ...
          <p className="text-sm">
            ...
            from web forms in C# and .NET Core. Published updates and new pages
            to the customer-facing website using HTML, CSS, and JavaScript.
            Administered user security within the primary documentation
            application used by bank employees.
          </p>
        </div>
        <div className="py-5">
        ...
        <div className="py-5">
          ...
          <p className="text-sm">
            Implemented solutions for bugs and features within the Zetta product
            utilizing C# and .NET Core. Utilized the scrum framework from a
            developer perspective in order to prioritize tickets and explain
            previous work and roadblocks to colleagues.
          </p>
        </div>
        <div className="py-5">
          ...
          <p className="text-sm">
            ...
            quality assurance perspective in order to prioritize testing tasks.
            Wrote and edited clear and concise testing instructions for bug,
      ...
      <section id="projects">
        ...
        <div className="py-5">
          ...
          <p className="text-sm">
            website built using NextJS, TailwindCSS, Typescript, and Motion for
            animation. utilizes Prismic headless content management system.
            hosted on Netlify.
          </p>
        </div>
      </section>
